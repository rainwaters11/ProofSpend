...
export class MockIdentityAdapter {
  getIdentity(): AgentIdentityRef { return { standard: "ERC-8004", chainId: "synthetic:arc-testnet", registryAddress: "mock:not-a-registry", agentId: "mock:unregistered:proofspend", ownerAddress: "mock:owner", registrationTransactionHash: null, registrationStatus: "UNREGISTERED", isMock: true }; }
}
